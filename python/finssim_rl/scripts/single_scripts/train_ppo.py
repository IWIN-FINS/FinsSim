...
def main():
    # 解析命令行参数
    parser = argparse.ArgumentParser(description="Train PPO on underwater simulation")
    parser.add_argument("--exp-name", type=str, default="PPO_default", 
    ...
    # 开始训练
    model.learn(total_timesteps=5000000, callback=callback_list, progress_bar=True, reset_num_timesteps=False)
